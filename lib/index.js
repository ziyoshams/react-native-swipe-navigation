...
import { View, Animated, BackHandler, Dimensions, Platform } from 'react-native';
    ...
    class Manager extends React.Component {
      constructor(props) {
        ...
        this.state = {
          ...
          screen_b: () => <View style={{ height, width }} />,
          screenName_b: '',
          style_b: { zIndex: 1 },
      ...
      onSwipeLeftStarted() {
        ...
        const { isBack, screen, screenName, type, color } = result;
        const main = this.stateAPI.getMain();
        let mainStyle = {};
        let style = {};
        this.isBack = false;
        ...
        if (isBack) {
          this.isBack = true;
          [mainStyle, style] = get_styles(
            STYLES.NAVIGATE_BACK_RIGHT,
            { dx: this.state.dx },
            { type: main.type, color: main.color }
          );
        } else {
        ...
        this.update(screenName, screen, mainStyle, style, () => {
          this.navAPI.fireOnNavigateRightStartedListener(main.screenName, {
            interpolation: this.state.dx,
            isBack: this.isBack,
            isMain: true
          });
          this.navAPI.fireOnNavigateRightStartedListener(screenName, {
            interpolation: this.state.dx,
            isBack: this.isBack,
            isMain: false
          });
          this.onFinishNavigating = completed => {
            this.navAPI.fireOnNavigateRightCompletedListener(main.screenName, {
              completed,
              isBack: this.isBack,
              isMain: true
            });
            this.navAPI.fireOnNavigateRightCompletedListener(screenName, {
              completed,
              isBack: this.isBack,
              isMain: false
            });
      ...
      onSwipeRightStarted() {
        ...
        this.update(screenName, screen, mainStyle, style, () => {
          this.navAPI.fireOnNavigateLeftStartedListener(main.screenName, {
            interpolation: this.state.dx,
            isBack: this.isBack,
            isMain: true
          });
          this.navAPI.fireOnNavigateLeftStartedListener(screenName, {
            interpolation: this.state.dx,
            isBack: this.isBack,
            isMain: false
          });
          this.onFinishNavigating = completed => {
            this.navAPI.fireOnNavigateLeftCompletedListener(main.screenName, {
              completed,
              isBack: this.isBack,
              isMain: true
            });
            this.navAPI.fireOnNavigateLeftCompletedListener(screenName, {
              completed,
              isBack: this.isBack,
              isMain: false
            });
      ...
      onSwipeUpStarted() {
        ...
        this.update(screenName, screen, mainStyle, style, () => {
          this.navAPI.fireOnNavigateDownStartedListener(main.screenName, {
            interpolation: this.state.dy,
            isBack: this.isBack,
            isMain: true
          });
          this.navAPI.fireOnNavigateDownStartedListener(screenName, {
            interpolation: this.state.dy,
            isBack: this.isBack,
            isMain: false
          });
          this.onFinishNavigating = completed => {
            this.navAPI.fireOnNavigateDownCompletedListener(main.screenName, {
              completed,
              isBack: this.isBack,
              isMain: true
            });
            this.navAPI.fireOnNavigateDownCompletedListener(screenName, {
              completed,
              isBack: this.isBack,
              isMain: false
            });
      ...
      onSwipeDownStarted() {
        ...
        this.update(screenName, screen, mainStyle, style, () => {
          this.navAPI.fireOnNavigateUpStartedListener(main.screenName, {
            interpolation: this.state.dy,
            isBack: this.isBack,
            isMain: true
          });
          this.navAPI.fireOnNavigateUpStartedListener(screenName, {
            interpolation: this.state.dy,
            isBack: this.isBack,
            isMain: false
          });
          this.onFinishNavigating = completed => {
            this.navAPI.fireOnNavigateUpCompletedListener(main.screenName, {
              completed,
              isBack: this.isBack,
              isMain: true
            });
            this.navAPI.fireOnNavigateUpCompletedListener(screenName, {
              completed,
              isBack: this.isBack,
              isMain: false
            });
      ...
      navigate(screen, config) {
        ...
        const values =
          this.state.main === 'A'
            ? {
                main: 'B',
                screen_b: main.screen,
                screenName_b: main.screenName,
                style_a: { zIndex: 1 },
                style_b: { zIndex: 2 }
              }
            : {
                main: 'A',
                screen_a: main.screen,
                screenName_a: main.screenName,
                style_a: { zIndex: 2 },
                style_b: { zIndex: 1 }
              };
      ...
      render() {
        return (
          <Gesture
            ...
            <Transitioner
              component={this.state.screen_a}
              style={this.state.style_a}
              nav={nav.getPropsApi(this.state.screenName_a)}
              overlay_zIndex={this.state.overlay_zIndex}
            />
            <Transitioner
              component={this.state.screen_b}
              style={this.state.style_b}
              nav={nav.getPropsApi(this.state.screenName_b)}
              overlay_zIndex={this.state.overlay_zIndex}
            />
