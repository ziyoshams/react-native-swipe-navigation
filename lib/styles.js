...
function navigateLeftMainStyle(dx, { type, color }) {
  ...
  if (type === 'over' || type === 'place') {
    ...
    left = dx.interpolate({ inputRange: [0, width], outputRange: [0, width] });
  }
...
function navigateLeftStyle(dx, { type }) {
  ...
  if (type === 'place') {
    ...
    left = dx.interpolate({ inputRange: [0, width], outputRange: [-width, 0], easing });
  }
...
function navigateBackRightMainStyle(dx, { type }) {
  ...
  if (type === 'place') {
    ...
    left = dx.interpolate({ inputRange: [-width, 0], outputRange: [-width, 0], easing });
  }
...
function navigateBackRightStyle(dx, { type, color }) {
  ...
  if (type === 'over') {
    ...
    left = dx.interpolate({ inputRange: [-width, 0], outputRange: [0, width], easing });
  }
...
function navigateBackLeftMainStyle(dx, { type }) {
  ...
  if (type === 'place') {
    ...
    left = dx.interpolate({ inputRange: [0, width], outputRange: [0, width], easing });
  }
...
function navigateDownMainStyle(dy, { type, color }) {
  ...
  if (type === 'over' || type === 'place') {
    ...
    top = dy.interpolate({ inputRange: [-height, 0], outputRange: [-height, 0], easing });
  }
...
function navigateDownStyle(dy, { type }) {
  ...
  if (type === 'place') {
    ...
    top = dy.interpolate({ inputRange: [-height, 0], outputRange: [0, height], easing });
  }
...
function navigateBackUpStyle(dy, { type, color }) {
  ...
  if (type === 'over') {
    ...
    top = dy.interpolate({ inputRange: [0, height], outputRange: [-height, 0], easing });
  }
...
function navigateUpMainStyle(dy, { type, color }) {
  ...
  if (type === 'over' || type === 'place') {
    ...
    top = dy.interpolate({ inputRange: [0, height], outputRange: [0, height], easing });
  }
